...
class GrammarParserTest {
	...
	@Test
	void parseWellTokens() throws ParsingException {
		...
		test("LINE_END='\\r\\n'\r\n" + 
				...
				"WHITESPACE='[ \\t]+'\r\n" + 
				"SLASH='\\/'\r\n" + 
				"COMMA=','", true, tokens, new ArrayList<>());
	}
	
	@Test
	void parseTokensWithComments() throws ParsingException{
		ArrayList<String> tokens = new ArrayList<>();
		tokens.add("LINE_END");
		tokens.add("IDENTIFYER");
		tokens.add("EQ");
		...
		test("//General\r\n" + 
				...
				"QUOTE='(?<!\\\\)\\\\''\r\n" + 
				"ESCAPED_QUOTE='\\\\\\\\''\r\n" + 
				"BACKSLASH='\\\\(?!\\')'", true, tokens, new ArrayList<>());
	}
	
	private static void test(String s,boolean debug,ArrayList<String> tokenNamesExpected,ArrayList<String> expectedGrammarNames) throws ParsingException {
