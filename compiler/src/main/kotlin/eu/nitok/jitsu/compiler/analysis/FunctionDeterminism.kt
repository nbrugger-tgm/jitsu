...
data class ParameterInfo(
    val passingType: Access.VariableAccess.AccessKind,
...
class CodeBlockAnalysis(
    ...
    private fun processExpression(expression: Expression, ownershipType: Access.VariableAccess.AccessKind): ValueInfo {
